...
✞ Open this link 👉 https://enzo-md-sessions-generator.onrender.com then tap on pair code.
✞ Enter your whatsapp number with the country code e.g;  254784115308 then tap submit 
✞last hope Md owner , *ENZO* ,will send you the code immediately.Copy the code and whatsapp will bring a notification 
✞Tap on the notification and paste the code that lasthope md owner sent you.
✞ After a successful login lasthope Md owner 😂 enzo will send you a *session id* .some will wonder where the hell is that session ,,,...It is just right at your inbox /dm {your own number for whatsappp} 😂
✞Copy the Session id {the one with unreadable codes and long copy it and send it to your deployer or deploy
     HOW TO DEPLOY LAST HOPE MD
✔ Now check on last hope repository in github fork and give a star to this repository before doing anything 🌟or else lasthope Md owner won't allow you to deploy his bot💀.
...
✔Now click on this devs number and give lasthope md owner credits https://wa.me/254784115308
╰────────────────────☆`;
let menuMsg = `
     𝐑𝐞𝐠𝐚𝐫𝐝𝐬 ENZO TECH`;
   var lien = mybotpic();
